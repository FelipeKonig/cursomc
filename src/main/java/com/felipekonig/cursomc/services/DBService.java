...
import com.felipekonig.cursomc.domain.Pagamento;
import com.felipekonig.cursomc.domain.PagamentoComBoleto;
import com.felipekonig.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		repoProduto.saveAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26,
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "lipekkk@gmail.com", "3637411891", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("11981645", "19813187"));

		Cliente cli2 = new Cliente(null, "Felipe Konig", "lipekonig@gmail.com", "21725973090", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli1.getTelefones().addAll(Arrays.asList("995891", "3498732"));
		...
		Endereco e3 = new Endereco(null, "Floriano", "2106", null, "Centro", "43243", cli2, c2);

		cli1.getEnderecos().addAll(Arrays.asList(e1, e2));
		cli2.getEnderecos().add(e3);

		repoCliente.saveAll(Arrays.asList(cli1, cli2));
		repoEndereco.saveAll(Arrays.asList(e1, e2, e3));
